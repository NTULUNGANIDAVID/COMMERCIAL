...
{    
    ...
    public class DGVPrinter
    {
        ...
        public void PrintNoDisplay(DataGridView dgv)
        {
            ...
            {
                MessageBox.Show("Ce dossier que vous voulais remplacer est déjà ouvert, veuillez d'abord le fermer, soit renommz-lez");
            }
        ...
        public int SubTitleFormatFlag { get; set; }
