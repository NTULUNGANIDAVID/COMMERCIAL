...
namespace WindowsFormsApplication1
{
    public partial class PAGE_ACCUEIL : Form
    {
        ...
        public void ajouprod()
        {
            ...
            else
            {
                try
                {
                    ...
                    if (conn.cmd1.ExecuteNonQuery() == 1)
                    {
                        MessageBox.Show("Article " + " " + richprod.Text + " *** est bien approvisionné");
                        annulapprov();
                    }
                    else
                    {
        ...
        {
            conn.communication();
            conn.da = new SqlDataAdapter("select * FROM [dbo].[Approvisionnements]", conn.con);
            conn.dt = new DataTable();
            conn.ds=new DataSet();
            conn.da.Fill(conn.ds, scr_val, 50, "Approvisionnements");
        ...
        void SOMMEBENEJOUR()
        {
            ...
            conn.cmd1.Connection = conn.con;
            conn.cmd1.CommandType = CommandType.Text;
            conn.cmd1.CommandText = "select sum(Benefice)Benefice from [dbo].[T_benefice] where Dateope='" + DateTime.Today.ToString("yyyy-MM-dd") + "'";
        ...
        void sommegenemoi()
        {
            ...
            conn.cmd.CommandText = "select sum(Benefice)Benefice from [dbo].[T_benefice] where Mois='" + labMoisOperation.Text + "'";
        ...
        void totalgeneralmoi()
        {
            ...
            conn.cmd.Connection = conn.con;
            conn.cmd.CommandType = CommandType.Text;
            conn.cmd.CommandText = "select sum(Prix_total)Prix_total from [dbo].[Ventes] where Mois='" + labMoisOperation.Text + "'";
        ...
        void totalventescredits()
        {
            ...
            conn.cmd3.CommandText = "select sum(Prix_total)Prix_total from [dbo].[Vente_credit]";
        ...
        void sommeventejour()
        {
            ...
            conn.cmd3.Connection = conn.con;
            conn.cmd3.CommandType = CommandType.Text;
            conn.cmd3.CommandText = "select sum(Prix_total)Prix_total from [dbo].[Ventes] where Date_vendu='" + DateTime.Today.ToString("yyyy-MM-dd") + "'";
        ...
        void methodedepensesjour()
        {
            ...
            conn.cmd.Connection = conn.con;
            conn.cmd.CommandType = CommandType.Text;
            conn.cmd.CommandText = "select sum(Montant)Montant from [dbo].[Depense_prod] where Datedepense='" + DateTime.Today.ToString("yyyy-MM-dd") + "'";
        ...
        void methodedepensesdumoi()
        {
            ...
            conn.cmd3.Connection = conn.con;
            conn.cmd3.CommandType = CommandType.Text;
            conn.cmd3.CommandText = "select sum(Montant)Montant FROM [dbo].[Depense_prod] where Mois ='" + labMoisOperation.Text + "'";
            ...
            try
            {
                ...
                else
                {
                    if (txtprixv.Text.Length != 0)
                    {
                        ...
                        conn.cmd1.Connection = conn.con;
                        conn.cmd1.CommandType = CommandType.Text;
                        conn.cmd1.CommandText = "select Qte_sotock from [dbo].[Approvisionnements] where Nom_prod='" +Regex.Replace( richnomprod.Text,"'","''") + "'";
                        ...
                        else
                        {
                            ...
                            conn.cmd1.CommandType = CommandType.Text;
                            conn.communication();
                            conn.cmd1.CommandText = "update [dbo].[Approvisionnements] set Qte_sotock='" + QteAugmentat + "' where Nom_prod='" + richnomprod.Text + "'";
        ...
        void supfact()
        {
            ...
            try
            {
                ...
                conn.cmd2.Connection = conn.con;
                conn.cmd2.CommandType = CommandType.Text;
                conn.cmd2.CommandText = " DELETE FROM [dbo].[Factures]";
                conn.cmd2.ExecuteNonQuery();
        ...
        void Supprimerrpjpour()
        {
            ...
            try
            {
                ...
                conn.cmd1.Connection = conn.con;
                conn.cmd1.CommandType = CommandType.Text;
                conn.cmd1.CommandText = " DELETE FROM [dbo].[Rapportjour]";
                conn.cmd1.ExecuteNonQuery();
        ...
        void MethodeInformArticleVenteformes()
        {
            ...
            conn.cmd.Connection = conn.con;
            conn.cmd.CommandType = CommandType.Text;
            conn.cmd.CommandText = "SELECT [Nom_prod],[PA],[Qte_sotock],[Num_lot],[Famille],[Rayon] FROM [GS_ALIMENT].[dbo].[Approvisionnements] where Nom_prod ='" + richformes.Text + "'";
            conn.dr = conn.cmd.ExecuteReader();
            if (conn.dr.HasRows)
            {
        ...
        void MethodeAfficheListeBoxVenteformes()
        {
            try
            {
                ...
                {
                    listbyforme.Visible = true;
                    conn.cmd.CommandText = "SELECT * FROM (Nom_prod) as Prod [dbo].[Approvisionnements] where Famille like'" + richformes.Text + "%' order by Famille  ASC";
        ...
        void MethodeInformArticleqteaprovis()
        {
            ...
            conn.cmd2.Connection = conn.con;
            conn.cmd2.CommandType = CommandType.Text;
            conn.cmd2.CommandText = "SELECT [Num_lot],[Nom_prod],[Qte_sotock],[PA],[StockEntre],[Famille],[Rayon],[Date_exp],[Unites],[ID] FROM [GS_ALIMENT].[dbo].[Approvisionnements] where Nom_prod ='" + textnomartapprv.Text + "'";
        ...
        void recuppriventeetpourcentage()
        {
            ...
            conn.cmd1.Connection = conn.con;
            conn.cmd1.CommandType = CommandType.Text;
            conn.cmd1.CommandText = "SELECT [PA] FROM [dbo].[Approvisionnements] where Nom_prod ='" + richnomprod.Text + "'";
            conn.dr = conn.cmd1.ExecuteReader();
            if (conn.dr.HasRows)
            {
                if (conn.dr.Read())
                {
                    // txtprixv.Text = conn.dr["PV"].ToString()
        ...
        void recustockdispo()
        {
            ...
            conn.cmd2.Connection = conn.con;
            conn.cmd2.CommandType = CommandType.Text;
            conn.cmd2.CommandText = "SELECT [Num_lot],[Qte_sotock],[Famille],[Rayon],[Unites] FROM [dbo].[Approvisionnements] where Nom_prod ='" + richnomprod.Text + "'";
        ...
        private void PAGE_ACCUEIL_Shown(object sender, EventArgs e)
        {
            ...
            conn.communication();
            conn.da = new SqlDataAdapter("SELECT * FROM [dbo].[Depense_prod] ", conn.con);
            conn.dt = new DataTable();
            ...
            try
            {
                ...
                else
                {
                    if (textnomartapprv.Text.Length != 0)
                    {
                        ...
                        conn.cmd3.Connection = conn.con;
                        conn.cmd3.CommandType = CommandType.Text;
                        conn.cmd3.CommandText = "select Qte_sotock from [dbo].[Approvisionnements] where Nom_prod='" +Regex.Replace( textnomartapprv.Text,"'","''") + "'";
                        conn.dr = conn.cmd3.ExecuteReader();
                        while (conn.dr.Read())
                        {
                            stockQte = Convert.ToDouble(conn.dr["Qte_sotock"]);
                        ...
                        conn.cmd.Connection = conn.con;
                        conn.cmd.CommandType = CommandType.Text;
                        echo = MessageBox.Show("Voulez-vous ajouter la quantité de cet article?", "GS-COMMERCIALE", MessageBoxButtons.YesNo, MessageBoxIcon.Information);
                        if (echo == DialogResult.Yes)
                        {
                            //conn.communication();
                            ...
                            MessageBox.Show("La mise a jours " + textnomartapprv.Text + " est effectuée");
                            textqreajout.Clear();
                        }
                        conn.dr.Close();
                    }
        ...
        private void PAGE_ACCUEIL_Load(object sender, EventArgs e)
        {
            ...
            conn.communication();
            conn.da = new SqlDataAdapter("SELECT Nom_prod, Qte_sotock, PA, Date_enre FROM [dbo].[Approvisionnements] where Qte_sotock <= 3", conn.con);
            ...
            conn.communication();
            conn.da1 = new SqlDataAdapter("select [Nom_prod],[StockEntre],[Date_enre] FROM [GS_ALIMENT].[dbo].[Approvisionnements] ", conn.con);
            conn.dt1 = new DataTable();
            conn.ds1 = new DataSet();
            conn.da1.Fill(conn.ds1, scr_david, 50, "Approvisionnements");
        ...
        void methodedepense()
        {
            ...
            else
            {
                if (montantdepense.Text.Length != 0 || richmotif.Text.Length != 0)
                {
                    ...
                    conn.cmd2.CommandText = "select Benefice from [dbo].[T_benefice]";
                    conn.dr2 = conn.cmd2.ExecuteReader();
                    while (conn.dr2.Read())
                    {
                    ...
                    {
                        MessageBox.Show("Désolé, le montant demander  est supérieur au bénéfice");
                        montantdepense.Focus();
                    }
                    else if (stockQte == 0)
                    {
                    ...
                    {
                        MessageBox.Show("voulez-vous épuiser le bénéfice?");
                    }
                    else
                    {
                        ...
                        if (echo == DialogResult.Yes)
                        {
                            ...
                            conn.cmd2.Connection = conn.con;
                            conn.cmd2.CommandType = CommandType.Text;
                            conn.cmd2.CommandText = "insert into Depense_prod values('" + Regex.Replace(montantdepense.Text, "'", "''") + "', '" + Regex.Replace(richmotif.Text, "'", "''") + "','" + Regex.Replace(DateTime.Now.ToString("yyyy-MM-dd"), "'", "''") + "' ,'" + Regex.Replace(txtnomv.Text, "'", "''") + "','" + labMoisOperation.Text + "')";
                            conn.cmd2.ExecuteNonQuery();
        ...
        void sommegeneralbenefice()
        {
            ...
            conn.cmd2.Connection = conn.con;
            conn.cmd2.CommandType = CommandType.Text;
            conn.cmd2.CommandText = "select sum (Benefice) Benefice FROM [dbo].[T_benefice] where Dateope between '" + datedu.Value + "' and '" + dateau.Value + "'";
            conn.dr2 = conn.cmd2.ExecuteReader();
            if (conn.dr2.HasRows)
            {
                if (conn.dr2.Read())
        ...
        void sommegeneralentrevente()
        {
            ...
            conn.cmd.Connection = conn.con;
            conn.cmd.CommandType = CommandType.Text;
            conn.cmd.CommandText = "select sum (Prix_total) Prix_total FROM [dbo].[Ventes] where Date_vendu between '" + dateTimedu.Value + "' and '" + dateTimeau.Value + "'";
            conn.dr2 = conn.cmd.ExecuteReader();
            if (conn.dr2.HasRows)
            {
                if (conn.dr2.Read())
        ...
        void somdetouspromoi()
        {
            ...
            conn.cmd.Connection = conn.con;
            conn.cmd.CommandType = CommandType.Text;
            conn.cmd.CommandText = "select sum(Prix_total)Prix_total from [dbo].[Ventes] WHERE MOIS ='" + comboBox2.Text + "'";
            conn.dr2 = conn.cmd.ExecuteReader();
            while (conn.dr2.Read())
            {
        ...
        void MethodeAfficheListeBoxqteapprov()
        {
            try
            {
                ...
                {
                    listAddqte.Visible = true;
                    conn.cmd.CommandText = "SELECT distinct(Nom_prod) as Prod FROM [dbo].[Approvisionnements] where Nom_prod like'" + textnomartapprv.Text + "%' order by Nom_prod  ASC";
                    conn.dr = conn.cmd.ExecuteReader();
        ...
        void rechfactnote()
        {
            {
                conn.communication();
                conn.da2 = new SqlDataAdapter("select * FROM [dbo].[Ventes] where NumFacture like '%" + textrechfact.Text + "'", conn.con);
                conn.dt = new DataTable();
        ...
        void recharticleproformat()
        {
            {
                conn.communication();
                conn.da = new SqlDataAdapter("select [Num_lot],[Nom_prod],[Qte_sotock],[Date_enre],[Famille],[Unites],[PA],[Officine] FROM [dbo].[Approvisionnements] where Nom_prod like '" + txtrecherchearticle.Text + "%'", conn.con);
        ...
        void totalartapprov()
        {
            ...
            conn.cmd1.Connection = conn.con;
            conn.cmd1.CommandType = CommandType.Text;
            conn.cmd1.CommandText = "select COUNT (Nom_prod) Nom_prod from [dbo].[Approvisionnements] ";
            conn.dr = conn.cmd1.ExecuteReader();
            while (conn.dr.Read())
            {
        ...
        void totalartavendujour()
        {
           // conn.da = new SqlDataAdapter("select Nom_prod, SUM(Qte_vendue) AS Qte, SUM(Prix_total)  AS TOTAL, Date_vendu from [GS_ALIMENT].[dbo].[Ventes] where Date_vendu ='" + DateVentesjourssyntheses.Text + "' GROUP BY Nom_prod, Date_vendu ", conn.con);
            ...
            conn.cmd4.Connection = conn.con;
            conn.cmd4.CommandType = CommandType.Text;
            conn.cmd4.CommandText = "select COUNT (Nom_prod) AS Nom_prod, COUNT (Qte_vendue) AS Qte_vendue, Date_vendu from [GS_ALIMENT].[dbo].[Ventes] where Date_vendu ='" + DateTime.Today.ToString("yyyy-MM-dd") + "' GROUP BY Nom_prod, Date_vendu";
        ...
        void Noteretour()
        {
            ...
            else
            {
                if (texartic.Text.Length != 0 || textqteretour.Text.Length != 0)
                {
                    ...
                    conn.cmd2.Connection = conn.con;
                    conn.cmd2.CommandType = CommandType.Text;
                    conn.cmd2.CommandText = "select Qte_sotock from [dbo].[Approvisionnements] where Nom_prod='" + texartic.Text + "'";
                    conn.dr = conn.cmd2.ExecuteReader();
                    while (conn.dr.Read())
                    {
                        stockQte = Convert.ToDouble(conn.dr["Qte_sotock"]);
                    ...
                    {
                        //conn.communication();
                        conn.cmd1.CommandText = "update Approvisionnements set Qte_sotock='" + QteAugmentat + "' where Nom_prod='" + texartic.Text + "'";
                        conn.cmd1.ExecuteNonQuery();
        ...
        void enregistrernoteretour()
        {
            ...
            conn.cmd4 = new SqlCommand("INSERT [GS_ALIMENT].[dbo].[NRetour] values( @Nom_prod,@PV,@Qte_retour,@Date_retour,@Nom_vendeur,@Heur,@Num_Fac)", conn.con);                                                                                                                                                                                                                                                                                                                                                                                                                                                                   //[Emploi_2],[Num],[Av],[Quartier],[Commune]
        ...
        void Validerproforma()
        {
            ...
            {              
                conn.cmd4 = new SqlCommand("INSERT [GS_ALIMENT].[dbo].[Proforma] values (@Nom_prod,@PV,@Qte_vendue,@Prix_total,@Date_enre,@Qte_dispo,@Numprofo)", conn.con);                                                                                                                                                                                                                                                                                                                                                                                                                                                                   //[Emploi_2],[Num],[Av],[Quartier],[Commune]
        ...
        void Validerrequisition()
        {
            ...
            MessageBox.Show("Réquisition effectué");
        }
        ...
        void NumeroProforma()
        {
            try
            {
                ...
                conn.cmd4.Connection = conn.con;
                conn.cmd4.CommandType = CommandType.Text;
                conn.cmd4.CommandText = "SELECT [N_Ordre] FROM [dbo].[NumProforma]";
        ...
        void MethodeAfficheListedrh()
        {
            try
            {
                ...
                if (txtrecherches.Text.Length != 0)
                {
                    ...
                    conn.cmd.CommandText = "SELECT * FROM [GS_ALIMENT].[dbo].[Approvisionnements] where Nom_prod like'%" + txtrecherches.Text + "%'";
                    conn.dr = conn.cmd.ExecuteReader();
        ...
        public void Recherches()
        {
            ...
            conn.cmd.Connection = conn.con;
            conn.cmd.CommandType = CommandType.Text;
            conn.cmd.CommandText = " SELECT [Nom_prod],[Qte_sotock],[PA] FROM [GS_ALIMENT].[dbo].[Approvisionnements] where Nom_prod ='" + txtrecherches.Text + "'";
            conn.dr = conn.cmd.ExecuteReader();
            if (conn.dr.HasRows)
            {
                if (conn.dr.Read())
        ...
        {
            conn.communication();
            conn.da1 = new SqlDataAdapter("select [Articles],[Qtedispo],[Qterequisit],[Daterequis],[Site],[Demandeur],[Prix] FROM [dbo].[Requisition ] where Daterequis between '" + daterequisitiondu.Value + "' and '" + daterequisitionau.Value + "'", conn.con);
            conn.dt = new DataTable();
            conn.da1.Fill(conn.dt);
        ...
        void Selectsummerequisition()
        {
            ...
            conn.cmd.Connection = conn.con;
            conn.cmd.CommandType = CommandType.Text;
            conn.cmd.CommandText = "select sum(Prix)Prix from [GS_ALIMENT].[dbo].[Requisition] WHERE Daterequis between '" + daterequisitiondu.Value + "' and '" + daterequisitionau.Value + "'";
            conn.dr1 = conn.cmd.ExecuteReader();
            while (conn.dr1.Read())
            {
        ...
        void sommefondApprovisionnemnts()
        {
            ...
            conn.cmd4.Connection = conn.con;
            conn.cmd4.CommandType = CommandType.Text;
            conn.cmd4.CommandText = "select sum(PA)PA from [GS_ALIMENT].[dbo].[Approvisionnements]";
            conn.dr2 = conn.cmd4.ExecuteReader();
            while (conn.dr2.Read())
            {
        ...
        {
                conn.communication();
                conn.da1 = new SqlDataAdapter("select [Num_lot],[Nom_prod],[Qte_sotock],[Date_enre],[Rayon],[Date_exp], DATEDIFF(day, GETDATE(), Date_exp) as nbjours FROM [GS_ALIMENT].[dbo].[Approvisionnements] WHERE DATEDIFF(day, GETDATE(), Date_exp) <=123", conn.con);
                conn.dt1 = new DataTable();
        ...
        {
            conn.communication();
            conn.da1 = new SqlDataAdapter("select * FROM [GS_ALIMENT].[dbo].[Approvisionnements] WHERE Date_exp between '" + daterequisitiondu.Value + "' and '" + daterequisitionau.Value + "'", conn.con);
            conn.dt1 = new DataTable();
            conn.da1.Fill(conn.dt1);
        ...
        void totalartrequisit()
        {
            ...
            conn.cmd1.Connection = conn.con;
            conn.cmd1.CommandType = CommandType.Text;
            conn.cmd1.CommandText = "select COUNT (Articles) Articles from [GS_ALIMENT].[dbo].[Requisition] WHERE Daterequis between '" + daterequisitiondu.Value + "' and '" + daterequisitionau.Value + "' ";
            conn.dr = conn.cmd1.ExecuteReader();
            while (conn.dr.Read())
            {
        ...
        {
            conn.communication();
            conn.da1 = new SqlDataAdapter("select * FROM [GS_ALIMENT].[dbo].[Clients] ", conn.con);
            conn.dt = new DataTable();
            conn.da1.Fill(conn.dt);
        ...
        void sauvergarderclient()
        {
            try
            {
                ...
                conn.cmd2.Connection = conn.con;
                conn.cmd2.CommandType = CommandType.Text;
                conn.cmd2.CommandText = "insert into Clients values('" + Regex.Replace(textnomclient.Text, "'", "''") + "', '" + Regex.Replace(texttelephone.Text, "'", "''") + "','" + Regex.Replace(cmbtypeclient.Text, "'", "''") + "','" + Regex.Replace(DateTime.Now.ToString("yyyy-MM-dd"), "'", "''") + "')";
                if (conn.cmd2.ExecuteNonQuery() == 1)
                {
        ...
        public void SelectClient()
        {
            conn.communication();
            conn.cmd3 = new System.Data.SqlClient.SqlCommand();
            conn.cmd3.CommandText = "SELECT * FROM [GS_ALIMENT].[dbo].[Clients]";
            conn.cmd3.Connection = conn.con;
        ...
        public void SelectClientVentecredi()
        {
            conn.communication();
            conn.cmd = new System.Data.SqlClient.SqlCommand();
            conn.cmd.CommandText = "SELECT * FROM [GS_ALIMENT].[dbo].[Vente_credit]";
            conn.cmd.Connection = conn.con;
            SqlDataReader myreder;
            try
            {
        ...
        void MethodeInformArticleVenteforme()
        {
            ...
            conn.cmd1.Connection = conn.con;
            conn.cmd1.CommandType = CommandType.Text;
            conn.cmd1.CommandText = "SELECT [Nom_prod] FROM [GS_ALIMENT].[dbo].[Approvisionnements] where Nom_prod ='" + richformes.Text + "'";
            conn.dr2 = conn.cmd1.ExecuteReader();
            if (conn.dr2.HasRows)
            {
                listbyforme.Visible = true;
        ...
        void MethodeAfficheListeBoxVenteforme()
        {
            try
            {
                ...
                if (richformes.Text.Length != 0)
                {
                    ...
                    conn.cmd.CommandText = "SELECT Nom_prod FROM [dbo].[Approvisionnements] where Famille like'" + richformes.Text + "%' order by Famille  ASC";
                    conn.dr = conn.cmd.ExecuteReader();
                    listbyforme.Items.Clear();
                    while (conn.dr.Read())
                    {
        ...
        void MethodeInformArticleVente()
        {
            ...
            conn.cmd2.Connection = conn.con;
            conn.cmd2.CommandType = CommandType.Text;
            conn.cmd2.CommandText = "SELECT [Qte_sotock]FROM [GS_ALIMENT].[dbo].[Approvisionnements] where Nom_prod ='" + richnomprod.Text + "'";
            conn.dr = conn.cmd2.ExecuteReader();
            if (conn.dr.HasRows)
            {
        ...
        void MethodeAfficheListeBoxVente()
        {
            try
            {
                ...
                {
                    listBox1vente.Visible = true;
                    conn.cmd.CommandText = "SELECT distinct(Nom_prod) as Prod FROM [dbo].[Approvisionnements] where Nom_prod like'" + richrecherchenomprodby.Text + "%' order by Nom_prod  ASC";
                    conn.dr = conn.cmd.ExecuteReader();
        ...
        void Selectionnersommeclientcredit()
        {
            ...
            conn.cmd.Connection = conn.con;
            conn.cmd.CommandType = CommandType.Text;
            conn.cmd.CommandText = "select sum(Prix_total)Prix_total from [GS_ALIMENT].[dbo].[Vente_credit] WHERE Client='" + comboclientcredit.Text + "'";
            conn.dr1 = conn.cmd.ExecuteReader();
            while (conn.dr1.Read())
            {
        ...
        private void Btnprintesynthese_Click(object sender, EventArgs e)
        {
            ...
            //if (DateVentesjourssyntheses.Text == "")
            //{
            //    MessageBox.Show("Veuillez Selectionner la date svp");
            //}
            //else
            //{
            //    SqlConnection conn = new SqlConnection("Data Source = .\\SQLEXPRESS; Initial catalog = CARTE_ONEM; Integrated security = true");
            //    conn.Open();
            //    SqlCommand cmd2 = new SqlCommand("select Nom_prod, SUM(Qte_vendue) AS Qte, SUM(Prix_total)  AS TOTAL, Date_vendu from [GS_ALIMENT].[dbo].[Ventes] where Date_vendu ='" + DateVentesjourssyntheses.Text + "' GROUP BY Nom_prod, Date_vendu ", conn);
            //    cmd2.Parameters.AddWithValue("@Date_vendu", Convert.ToString(DateVentesjourssyntheses.Text));
            //    SqlDataAdapter da2 = new SqlDataAdapter(cmd2);
            //    DataSet dss = new DataSet();
            //    da2.Fill(dss, "GS_ALIMENT");
            //    ReportSyntetiquevente crysta = new ReportSyntetiquevente();
            //    crysta.SetDataSource(dss.Tables["EMPLOIS"]);

            //    PAGE_ACCUEIL PD = new PAGE_ACCUEIL();
            //    CallSyntheseVente call = new CallSyntheseVente();
            //    this.Hide();
            //    crysta.Load("crystalReportSyntheses.rpt");
            //    crysta.Refresh();
            //    crysta.SetParameterValue("SyntheseVentes", DateVentesjourssyntheses.Text);
            //    call.crystalReportSyntheses.ReportSource = crysta;
            //    call.Show();
            //}
        }
        ...
        {
            conn.communication();
            conn.da = new SqlDataAdapter("select [Nom_prod],[PV],[Qte_vendue],[Prix_total],[Date_enre],[Qte_dispo],[Numprofo] FROM [GS_ALIMENT].[dbo].[Proforma] where Numprofo LIKE '" + textrecheproforma.Text + "%'", conn.con);
            conn.dt2 = new DataTable();
            conn.da.Fill(conn.dt2);
        ...
        {
            conn.communication();
            conn.da = new SqlDataAdapter(" SELECT Nom_prod, SUM(Qte_vendue) AS Qte, SUM(Prix_total)  AS TOTAL, Date_vendu FROM [GS_ALIMENT].[dbo].[Ventes] WHERE Date_vendu between '" + datecontrolejournalier.Value + "' and '" + daterapportjournalier.Value + "' GROUP BY Nom_prod, Date_vendu ", conn.con);
            conn.dt = new DataTable();
            conn.da.Fill(conn.dt);
        ...
        void PrinteDatagridePreremption()
        {
            ...
            printer.Footer = "PHARMACIE DU COIN";
        ...
        private void datedepcontrole_ValueChanged(object sender, EventArgs e)
        {
            // Méthode pour afficher les dépenses automaiquement dans le datagride
            conn.communication();
            conn.da = new SqlDataAdapter("SELECT * FROM [dbo].[Depense_prod] WHERE Datedepense between '" + datedepdebut.Value + "' and '" + datedepcontrole.Value + "' ORDER BY Nom_Agent ", conn.con);
            conn.dt = new DataTable();
            conn.da.Fill(conn.dt);
            listedepenses.DataSource = conn.dt;
            conn.con.Close();
